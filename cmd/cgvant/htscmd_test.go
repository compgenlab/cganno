...
// TestBgzipAndTabix: `cgvant bgzip` compresses a file to a BGZF file, and `cgvant tabix`
...
// TestBgzipMergedIndex: `cgvant bgzip -o FILE -p vcf` writes the BGZF file AND its
