...
// TestBgzipAndTabix: `cganno bgzip` compresses a file to a BGZF file, and `cganno tabix`
...
// TestBgzipMergedIndex: `cganno bgzip -o FILE -p vcf` writes the BGZF file AND its
